...
function registerExpenseHandlers() {
    (0, licenseGuard_1.handleLicensed)('expenses:getAll', () => {
        return (0, database_1.dbAll)('SELECT * FROM expenses ORDER BY date DESC');
    });
    (0, licenseGuard_1.handleLicensed)('expenses:create', (_e, data) => {
    ...
    // ── Expense Categories ────────────────────────────────────────────────────
    (0, licenseGuard_1.handleLicensed)('expenseCategories:getAll', () => {
        return (0, database_1.dbAll)('SELECT * FROM expense_categories ORDER BY name ASC');
    });
    (0, licenseGuard_1.handleLicensed)('expenseCategories:create', (_e, data) => {
        const _id = (0, database_1.generateLocalId)();
        const ts = (0, database_1.now)();
    ...
    (0, licenseGuard_1.handleLicensed)('expenseCategories:delete', (_e, _id) => {
