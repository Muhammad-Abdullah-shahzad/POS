...
export function registerCategoryHandlers(): void {
  ...
  handleLicensed('categories:getAll', () => {
  ...
  handleLicensed('categories:create', (_e, data: Record<string, unknown>) => {
  ...
  handleLicensed('categories:update', (_e, _id: string, data: Record<string, unknown>) => {
    dbRun(
