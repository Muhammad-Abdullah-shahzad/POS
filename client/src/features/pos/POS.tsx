    ...
    <>
      ...
      <div className="print-only" style={{ display: 'none' }}>
        <div ref={componentRef}>
          <div id="printable-receipt" style={{ width: '300px', padding: '8px', boxSizing: 'border-box', margin: '0 auto', fontFamily: 'Arial, Helvetica, sans-serif', color: '#000', backgroundColor: '#fff', fontSize: '15px', fontWeight: 900, lineHeight: 1.4, WebkitPrintColorAdjust: 'exact', printColorAdjust: 'exact' }}>
            <div style={{ textAlign: 'center', marginBottom: '18px', borderBottom: '1px solid #000', paddingBottom: '12px' }}>
              <h1 style={{ margin: '0 0 4px', fontSize: '24px', fontFamily: 'Arial, Helvetica, sans-serif', fontWeight: 'bold', letterSpacing: '0', textTransform: 'uppercase' }}>Castlebar Halal Foods</h1>
              <p style={{ margin: '2px 0', fontSize: '13px', color: '#555' }}>Phone: +1 234 567 8900</p>
            </div>
            ...
            <div style={{ width: '100%', fontSize: '11px', color: '#333' }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '8px 0 4px', borderTop: '1px solid #000', fontWeight: 'bold', fontSize: '16px', color: '#000' }}>
            ...
            <div style={{ marginTop: '24px', textAlign: 'center', borderTop: '1px dashed #000', paddingTop: '10px' }}>
              <p style={{ margin: '0', fontSize: '12px', fontWeight: 'bold' }}>THANK YOU FOR SHOPPING!</p>
              <p style={{ margin: '3px 0 0', fontSize: '10px', color: '#555' }}>Please visit us again soon.</p>
            </div>
          </div>
        </div>
      </div>
