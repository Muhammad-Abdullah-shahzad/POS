...
const AdminDashboard = () => {
  ...
  const cards = [
    { key: 'total-sales', label: 'Total Sales',     value: fmtShort(totalSales),   sub: `${totalOrders} orders`,            icon: <IconTrendingUp size={20} />, color: 'violet' },
    { key: 'cash',        label: 'Cash',             value: fmtShort(cashSales),    sub: 'Cash + Split cash',                icon: <IconCash size={20} />,        color: 'green'  },
    { key: 'card',        label: 'Card',             value: fmtShort(cardSales),    sub: `${splitOrders.length} split`,      icon: <IconShoppingCart size={20} />, color: 'blue'   },
    { key: 'expenses',    label: 'Expenses',         value: fmtShort(totalExpenses),sub: `${expenseRatio}% of sales`,        icon: <IconReceipt size={20} />,      color: 'orange', ring: expenseRatio },
  ...
  return (
    <Stack gap="md">
      ...
      <Group justify="space-between" align="flex-start" wrap="nowrap">
        <div>
          <Title order={3}>Admin Overview</Title>
          <Text size="xs" c="dimmed">Tap any card for details</Text>
        </div>
        ...
        {cards.map((card) => (
          ...
          >
            <Group justify="space-between" mb={6} wrap="nowrap">
              ...
              <ThemeIcon color={card.color} variant="light" size="md" radius="md" style={{ flexShrink: 0 }}>
                {card.icon}
              </ThemeIcon>
            </Group>
